...
<link href="{{ asset('public/assets/css/css2.css') }}" rel="stylesheet">
<link href="{{ asset('public/assets/css/custom.css') }}" rel="stylesheet">
<link href="{{ asset('public/assets/css/cart.css') }}" rel="stylesheet">
<link href="{{ asset('public/assets/css/intlTelInput.css') }}" rel="stylesheet">
<link href="{{ asset('public/assets/date-timepicker/css/bootstrap-datetimepicker.css') }}" rel="stylesheet">
